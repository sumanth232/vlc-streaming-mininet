...
n = -1 # number of hosts
bw = 10.0  # 10 mbps link bandwidth
qos = 1     # 1 -> QoS is there

qos_k = 2 # y = 2x utility function for sd_flow

# capture_script = '/home/sumanth/mininetDir/capture.sh'
# sd_flow_filepath = '/home/sumanth/sample/360x240_2mb.mp4'
# hd_flow_filepath = '/home/sumanth/sample/720x480_5mb.mp4'
# stream_time = 40 # wait for 40 seconds before shutting down
# savedDir = '/home/sumanth/teststorage/'
# captureDir = '/home/sumanth/mininetDir/capture_traces'
...
savedDir = join(workingDir, 'savedStreams') # '/home/sumanth/teststorage/'
captureDir = join(workingDir, 'capturedTraces') # '/home/sumanth/mininetDir/capture_traces'
...
class SimpleTopo(Topo):
    ...
    def __init__(self, **opts):
        ...
        #linkopts = dict(bw=1000, use_htb=False)
        # self.addLink(h1, s1)
        # self.addLink(h2, s1)
        # self.addLink(h3, s2)
        # self.addLink(h4, s2)
...
def initiateCapture(h):
    ...
    for i in range((n/2)+1)[1:]:
        ...
        outFile = join(captureDir,outFile)
...
def vlcTest():
    ...
    topo = SimpleTopo()
    net = Mininet(topo=topo,host=CPULimitedHost, link=TCLink,
    controller=partial(RemoteController, ip='127.0.0.1', port=6633))   #-> should be added as argument in above line
